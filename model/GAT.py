...
class Attention(nn.Module):
    def __init__(self,opt):
        ...
        self.u_head1 = nn.Linear(opt["hidden_dim"], 32)
        self.u_head2 = nn.Linear(opt["hidden_dim"], 32)
        self.v_head1 = nn.Linear(opt["hidden_dim"], 32)
        self.v_head2 = nn.Linear(opt["hidden_dim"], 32)
        self.relu = nn.ReLU()
        self.opt = opt 
