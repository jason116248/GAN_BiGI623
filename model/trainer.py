...
class DGITrainer(Trainer):
    ...
    def distance(self, vec1, vec2):
        pdist = nn.PairwiseDistance(p = self.opt["hidden_dim"])
        return pdist(vec1, vec2)
    ...
    def reconstruct(self, UV, VU, UV_rated, VU_rated, relation_UV_adj, relation_VU_adj, adj,CUV, CVU,fake_adj, batch):
        ...
        mixup_real, mixup_fake = self.gen(user_hidden_out, item_hidden_out, fake_user_hidden_out, fake_item_hidden_out,
